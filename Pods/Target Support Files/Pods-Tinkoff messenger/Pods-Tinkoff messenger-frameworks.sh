...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/BoringSSL-GRPC-iOS11.0/openssl_grpc.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/abseil-iOS11.0/absl.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/gRPC-C++-iOS11.0/grpcpp.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/gRPC-Core-iOS11.0/grpc.framework"
